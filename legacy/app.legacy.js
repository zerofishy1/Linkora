...
function createSeedState() {
  return {
    ...
    tasks: [
      {
        id: "task-1",
        title: "Собрать пакет документов для новой услуги",
        description: "Финальная структура, тарифы, FAQ и лендинг-скелет.",
        status: "backlog",
        priority: "high",
        deadline: "05 апр",
        owner: "Хамид",
      ...
      {
        id: "task-2",
        title: "Переупаковать воронку лидов",
        description: "Очистить старые стадии и выстроить новые правила follow-up.",
        status: "active",
        priority: "medium",
        deadline: "07 апр",
        owner: "Хамид",
      ...
      {
        id: "task-3",
        title: "Проверить pipeline для AI-агентов",
        description: "Развести источники данных, MCP и локальные скиллы.",
        status: "review",
        priority: "high",
        deadline: "06 апр",
        owner: "Orbit AI",
      ...
      {
        id: "task-4",
        title: "Закрыть недельный отчёт по клиентам",
        description: "Краткий статус по сделкам, рискам и следующим действиям.",
        status: "done",
        priority: "low",
        deadline: "Выполнено",
        owner: "Хамид",
      ...
      {
        id: "task-5",
        title: "Настроить личный workspace home",
        description: "Довести до состояния ежедневного рабочего центра.",
        status: "active",
        priority: "high",
        deadline: "09 апр",
        owner: "Orbit AI",
    ...
    <section class="panel fade-in">
      <div class="page-head">
        <div>
          ...
          <p>Быстрый intake без модальных окон и перегруженных форм.</p>
        </div>
      </div>
      <form class="composer-card" data-form="add-task">
        <div class="form-grid">
          <div class="field">
          ...
          <div class="field-row">
            ...
            <div class="field">
              ...
              <input id="taskDeadline" name="deadline" placeholder="09 апр" />
            </div>
          </div>
          ...
          return `
            <div class="board-column">
              <div class="deal-column-head">
                ...
                <span class="pill-counter">${tasks.length}</span>
              </div>
              <div class="column-meta">Небольшой personal kanban вместо тяжёлого task manager.</div>
